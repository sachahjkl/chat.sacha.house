...
}:
{
  ...
  "@sveltejs/acorn-typescript@1.0.7" = fetchurl {
  ...
  "esrap@2.1.3" = fetchurl {
    url = "https://registry.npmjs.org/esrap/-/esrap-2.1.3.tgz";
    hash = "sha512-T/Dhhv/QH+yYmiaLz9SA3PW+YyenlnRKDNdtlYJrSOBmNsH4nvPux+mTwx7p+wAedlJrGoZtXNI0a0MjQ2QkVg==";
  };
  "fdir@6.5.0" = fetchurl {
  ...
  "runed@0.36.0" = fetchurl {
    url = "https://registry.npmjs.org/runed/-/runed-0.36.0.tgz";
    hash = "sha512-CK84KPwAausPQEyWF9t6miCuNW5isAKPMswDsz7jhdueiZZ9du/UrgWc/aggLts8QuppT8KucryrHDFBAqk9Ww==";
  };
  "sade@1.8.1" = fetchurl {
